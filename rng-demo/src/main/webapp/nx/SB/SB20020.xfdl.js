(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("가상계좌");
            obj.set_url("SB::SB20020T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("카드");
            obj.set_url("SB::SB20020T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("무통장");
            obj.set_url("SB::SB20020T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("어음");
            obj.set_url("SB::SB20020T04.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","SB::SB20020T01.xfdl");
            this._addPreloadList("fdl","SB::SB20020T02.xfdl");
            this._addPreloadList("fdl","SB::SB20020T03.xfdl");
            this._addPreloadList("fdl","SB::SB20020T04.xfdl");
        };
        
        // User Script
        this.registerScript("SB20020.xfdl", function() {
        ...
        this.loadIncludeScript("SB20020.xfdl");
