(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("기존계약(장기) 매출 산출");
            ...
            obj.set_text("유지율");
            obj.set_url("BP::BP10040T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("대여매출");
            obj.set_url("BP::BP10040T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("위약금매출");
            obj.set_url("BP::BP10040T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("기타매출");
            obj.set_url("BP::BP10040T04.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10040T01.xfdl");
            this._addPreloadList("fdl","BP::BP10040T02.xfdl");
            this._addPreloadList("fdl","BP::BP10040T03.xfdl");
            this._addPreloadList("fdl","BP::BP10040T04.xfdl");
        };
        
        // User Script
        this.registerScript("BP10040.xfdl", function() {
        ...
        this.loadIncludeScript("BP10040.xfdl");
