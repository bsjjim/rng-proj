(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("고정비 산출");
            obj.set_url("BP::BP10070T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("배부율 산출");
            obj.set_url("BP::BP10070T02.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10070T01.xfdl");
            this._addPreloadList("fdl","BP::BP10070T02.xfdl");
            this._addPreloadList("fdl","BP::BP10070T03.xfdl");
        };
        
        // User Script
        this.registerScript("BP10070.xfdl", function() {
        ...
        this.loadIncludeScript("BP10070.xfdl");
