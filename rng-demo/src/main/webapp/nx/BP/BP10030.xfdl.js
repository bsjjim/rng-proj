(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("잔존률");
            obj.set_url("BP::BP10030T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("반납_중도");
            obj.set_url("BP::BP10030T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("반납_정상");
            obj.set_url("BP::BP10030T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("반납_전체");
            obj.set_url("BP::BP10030T04.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage5",this.Tab00);
            obj.set_text("반납_지점배분");
            obj.set_url("BP::BP10030T05.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage6",this.Tab00);
            obj.set_text("매각예정");
            obj.set_url("BP::BP10030T06.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10030T01.xfdl");
            this._addPreloadList("fdl","BP::BP10030T02.xfdl");
            this._addPreloadList("fdl","BP::BP10030T03.xfdl");
            this._addPreloadList("fdl","BP::BP10030T04.xfdl");
            this._addPreloadList("fdl","BP::BP10030T05.xfdl");
            this._addPreloadList("fdl","BP::BP10030T06.xfdl");
        };
        
        // User Script
        this.registerScript("BP10030.xfdl", function() {
        ...
        this.loadIncludeScript("BP10030.xfdl");
