(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("월별 업로드 항목 관리");
            ...
            obj.set_text("차량관리");
            obj.set_url("BP::BP10420T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("매출/주행거리");
            obj.set_url("BP::BP10420T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("가동시간");
            obj.set_url("BP::BP10420T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("손익계산서");
            obj.set_url("BP::BP10420T04.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage5",this.Tab00);
            obj.set_text("위탁전 손익계산서");
            obj.set_url("BP::BP10420T05.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage6",this.Tab00);
            obj.set_text("재무상태표");
            obj.set_url("BP::BP10420T06.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage7",this.Tab00);
            obj.set_text("인원수 및 단가");
            obj.set_url("BP::BP10420T07.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage8",this.Tab00);
            obj.set_text("지표 산출");
            obj.set_url("BP::BP10420T08.xfdl");
            this.Tab00.addChild(obj.name, obj);
            ...
            obj = new Static("Static02_01_00_00_00_01_00","427","18","20","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("22");
            obj.set_text("년");
            obj.set_cssclass("sta_WF_unit");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static02_01_00_00_00_01_00_00","566","18","20","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("23");
            obj.set_text("월");
            obj.set_cssclass("sta_WF_unit");
            this.DivSearch.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10420T01.xfdl");
            this._addPreloadList("fdl","BP::BP10420T02.xfdl");
            this._addPreloadList("fdl","BP::BP10420T03.xfdl");
            this._addPreloadList("fdl","BP::BP10420T04.xfdl");
            this._addPreloadList("fdl","BP::BP10420T05.xfdl");
            this._addPreloadList("fdl","BP::BP10420T06.xfdl");
            this._addPreloadList("fdl","BP::BP10420T07.xfdl");
            this._addPreloadList("fdl","BP::BP10420T08.xfdl");
        };
        
        // User Script
        this.registerScript("BP10420.xfdl", function() {
        ...
        this.loadIncludeScript("BP10420.xfdl");
