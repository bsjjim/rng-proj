(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("전사");
            obj.set_url("BP::BP10360T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("계획수립단위");
            obj.set_url("BP::BP10360T02.xfdl");
            this.Tab00.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        {
            this._addPreloadList("fdl","BP::BP10360T01.xfdl");
            this._addPreloadList("fdl","BP::BP10360T02.xfdl");
        };
        
        // User Script
        this.registerScript("BP10360.xfdl", function() {
        ...
        this.loadIncludeScript("BP10360.xfdl");
