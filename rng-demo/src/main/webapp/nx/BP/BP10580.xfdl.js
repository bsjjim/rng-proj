(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new CheckBox("CheckBox00_00","150","54","80","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("5");
            obj.set_text("오토렌탈");
            obj.set_value("true");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CheckBox("CheckBox00_01","234","54","80","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("6");
            obj.set_text("일반렌탈");
            obj.set_value("true");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CheckBox("CheckBox00_00_00","318","54","80","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("7");
            obj.set_text("오토리스");
            obj.set_value("true");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00","20","54","58","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("9");
            obj.set_text("조회항목");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CheckBox("CheckBox00_00_00_00","466","54","80","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("10");
            obj.set_text("오토케어");
            obj.set_value("true");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CheckBox("CheckBox00_00_00_00_00","402","54","60","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("11");
            obj.set_text("그린카");
            obj.set_value("true");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CheckBox("CheckBox00_00_00_00_00_00_00","550","54","100","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("12");
            obj.set_text("중고차사업단");
            obj.set_value("true");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj.set_text("오토렌탈");
            obj.set_url("BP::BP10580T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("일반렌탈");
            obj.set_url("BP::BP10580T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("오토리스");
            obj.set_url("BP::BP10580T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage5",this.Tab00);
            obj.set_text("그린카");
            obj.set_url("BP::BP10580T04.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage6",this.Tab00);
            obj.set_text("오토케어");
            obj.set_url("BP::BP10580T05.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage7",this.Tab00);
            obj.set_text("중고차사업단");
            obj.set_url("BP::BP10580T06.xfdl");
            this.Tab00.addChild(obj.name, obj);
            ...
            obj = new Button("Button00_00_00_00_00",null,"10","167","28","227",null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("3");
            obj.set_text("전사지표 양식다운로드");
            obj.set_cssclass("btn_Comm_func");
            this.div00_00.addChild(obj.name, obj);

            obj = new Button("Button00_00_00_00_00_00",null,"10","155","28","68",null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("4");
        ...
        {
            this._addPreloadList("fdl","BP::BP10580T01.xfdl");
            this._addPreloadList("fdl","BP::BP10580T02.xfdl");
            this._addPreloadList("fdl","BP::BP10580T03.xfdl");
            this._addPreloadList("fdl","BP::BP10580T04.xfdl");
            this._addPreloadList("fdl","BP::BP10580T05.xfdl");
            this._addPreloadList("fdl","BP::BP10580T06.xfdl");
        };
        
        // User Script
        this.registerScript("BP10580.xfdl", function() {
        ...
        this.loadIncludeScript("BP10580.xfdl");
