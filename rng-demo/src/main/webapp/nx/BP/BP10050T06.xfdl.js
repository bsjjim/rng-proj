(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","0","20","101","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("2");
            obj.set_text("타이틀영역");
            obj.set_cssclass("sta_WF_title1");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00_00_02_00_00_00_00",null,"20","103","24","698",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("3");
            obj.set_text("CD매출_비용률");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00_00_02_00_00_00_00_00",null,"20","83","24","580",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("4");
            obj.set_text("/ 비중(장기)");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00_00_02_00_00_00_00_01",null,"20","88","24","459",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("5");
            obj.set_text("/ 비중(단기)");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit00_00_00_00",null,"20","30","24","666",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("6");
            obj.set_format("#,###.##");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00_00",null,"17","20","30","395",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("7");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new MaskEdit("MaskEdit00_00_00_00_00",null,"20","30","24","433",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("8");
            obj.set_format("#,###.##");
            this.Div01.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit00_00_00_00_01",null,"20","30","24","549",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_format("#,###.##");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static02_00_00_00_00_00_02_00_00_00",null,"20","38","24","363",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("15");
            obj.set_text("지표");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00",null,"20","135","24","225",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("16");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static02_00_00_00_00_00_02_00_00_00_00_00_00",null,"20","23","24","410",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("18");
            obj.set_text("%");
            ...
            obj = new Static("Static00","0","20","241","24",null,null,null,null,null,null,this.Div01_00.form);
            obj.set_taborder("2");
            obj.set_text("기존장기계약 대여매출 산출 상세");
        ...
        this.loadIncludeScript("BP10050T06.xfdl");
