(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("기존계약(장기) 변동비 산출");
            ...
            obj.set_text("감가상각비_차량");
            obj.set_url("BP::BP10050T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("감가상각비_개설원가");
            obj.set_url("BP::BP10050T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("차량보험료");
            obj.set_url("BP::BP10050T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("차량관리비");
            obj.set_url("BP::BP10050T04.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage5",this.Tab00);
            obj.set_text("자동차세");
            obj.set_url("BP::BP10050T05.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10050T01.xfdl");
            this._addPreloadList("fdl","BP::BP10050T02.xfdl");
            this._addPreloadList("fdl","BP::BP10050T03.xfdl");
            this._addPreloadList("fdl","BP::BP10050T04.xfdl");
            this._addPreloadList("fdl","BP::BP10050T05.xfdl");
            this._addPreloadList("fdl","BP::BP10050T06.xfdl");
        };
        
        // User Script
        this.registerScript("BP10050.xfdl", function() {
        ...
        this.loadIncludeScript("BP10050.xfdl");
