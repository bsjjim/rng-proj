(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","0","20","301","24",null,null,null,null,null,null,this.Div01_00.form);
            obj.set_taborder("2");
            obj.set_text("기존장기계약 감가상각비_개설원가 산출 상세");
        ...
        this.loadIncludeScript("BP10050T02.xfdl");
