(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("수선유지비 등 변동비");
            ...
            obj = new Combo("cmb00_00_00",null,"20","140","24","234",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj.set_text("감가상각_일반렌탈");
            obj.set_index("0");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00_00_02_00_00_00",null,"20","33","24","381",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_text("계정");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00_00",null,"0","20","50","214",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("10");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
        ...
        this.loadIncludeScript("BP10140T02.xfdl");
