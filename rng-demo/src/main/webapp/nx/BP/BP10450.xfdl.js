(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("인원수");
            obj.set_url("BP::BP10450T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("인건비 단가");
            obj.set_url("BP::BP10350T02.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10450T01.xfdl");
            this._addPreloadList("fdl","BP::BP10350T02.xfdl");
        };
        
        // User Script
        this.registerScript("BP10450.xfdl", function() {
        ...
        this.loadIncludeScript("BP10450.xfdl");
