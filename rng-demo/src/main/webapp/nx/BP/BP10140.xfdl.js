(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("감가상각비");
            obj.set_url("BP::BP10140T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("수선유지비 등 변동비");
            obj.set_url("BP::BP10140T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("대손상각비");
            obj.set_url("BP::BP10140T03.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10140T01.xfdl");
            this._addPreloadList("fdl","BP::BP10140T02.xfdl");
            this._addPreloadList("fdl","BP::BP10140T03.xfdl");
        };
        ...
        this.loadIncludeScript("BP10140.xfdl");
