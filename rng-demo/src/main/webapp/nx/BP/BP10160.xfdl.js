(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("인원수");
            obj.set_url("BP::BP10160T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("인건비");
            obj.set_url("BP::BP10160T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("인건비 외");
            obj.set_url("BP::BP10160T03.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10160T01.xfdl");
            this._addPreloadList("fdl","BP::BP10160T02.xfdl");
            this._addPreloadList("fdl","BP::BP10160T03.xfdl");
        };
        
        // User Script
        this.registerScript("BP10160.xfdl", function() {
        ...
        this.loadIncludeScript("BP10160.xfdl");
