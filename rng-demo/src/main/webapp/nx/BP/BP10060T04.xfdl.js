(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div01","0","0",null,null,"0","279",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div01");
            obj.set_cssclass("div_group");
            this.addChild(obj.name, obj);

            obj = new Radio("Radio00",null,"20","230","24","574",null,null,null,null,null,this.Div01.form);
            ...
            obj = new Combo("cmb00_00_00",null,"20","60","24","443",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("6");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static02_00_00_00_00_00_02_00_00_00",null,"20","98","24","503",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("7");
            obj.set_text("신규/기존 구분");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_01",null,"20","140","24","225",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var Div01_form_cmb00_00_01_innerdataset = new nexacro.NormalDataset("Div01_form_cmb00_00_01_innerdataset", obj);
            Div01_form_cmb00_00_01_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo>");
            obj.set_innerdataset(Div01_form_cmb00_00_01_innerdataset);
            obj.set_text("차량금융렌탈이자수");
            obj.set_index("0");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00_00_02_00_00_01",null,"20","63","24","368",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_text("계획개정");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00_00_00_00",null,"17","20","30","423",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("10");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_00_00_00_00_00_00",null,"17","20","30","594",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("11");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00","95","20","242","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_initvalueid("iv_fc_blue");
            obj.set_taborder("12");
            obj.set_text("※ 조회 시 계획계정을 먼저 선택해 주세요!!");
            ...
            obj = new Static("Static01_00_00_00_00",null,"17","20","30","205",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("14");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static02_00_00_00_00_00_02_00_00",null,"20","38","24","174",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("15");
            obj.set_text("단위");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00_00_01","1386","17","10","30",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("17");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Div("Div01_00","0",null,null,"279","0","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div01");
            obj.set_cssclass("div_group");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"No\"/><Cell col=\"1\" rowspan=\"2\" text=\"영업부문\"/><Cell col=\"2\" rowspan=\"2\" text=\"지점\"/><Cell col=\"3\" rowspan=\"2\" text=\"채널Lv1\"/><Cell col=\"4\" rowspan=\"2\" text=\"채널Lv2\"/><Cell col=\"5\" rowspan=\"2\" text=\"고객Lv1\"/><Cell col=\"6\" rowspan=\"2\" text=\"고객Lv2\"/><Cell col=\"7\" rowspan=\"2\" text=\"고객Lv3\"/><Cell col=\"8\" rowspan=\"2\" text=\"상품Lv1\"/><Cell col=\"9\" rowspan=\"2\" text=\"상품Lv2\"/><Cell col=\"10\" rowspan=\"2\" text=\"상품Lv3\"/><Cell col=\"11\" rowspan=\"2\" text=\"상품Lv4\"/><Cell col=\"12\" rowspan=\"2\" text=\"경과차월/차령\"/><Cell col=\"13\" rowspan=\"2\" text=\"지표\" cssclass=\"cell_fix\"/><Cell col=\"14\" text=\"년\"/><Cell col=\"15\" text=\"년\"/><Cell col=\"16\" colspan=\"12\" text=\"년\"/><Cell col=\"28\" colspan=\"12\" text=\"년\"/><Cell row=\"1\" col=\"14\" text=\"합계\"/><Cell row=\"1\" col=\"15\" text=\"합계\"/><Cell row=\"1\" col=\"16\" text=\"1월\"/><Cell row=\"1\" col=\"17\" text=\"2월\"/><Cell row=\"1\" col=\"18\" text=\"3월\"/><Cell row=\"1\" col=\"19\" text=\"4월\"/><Cell row=\"1\" col=\"20\" text=\"5월\"/><Cell row=\"1\" col=\"21\" text=\"6월\"/><Cell row=\"1\" col=\"22\" text=\"7월\"/><Cell row=\"1\" col=\"23\" text=\"8월\"/><Cell row=\"1\" col=\"24\" text=\"9월\"/><Cell row=\"1\" col=\"25\" text=\"10월\"/><Cell row=\"1\" col=\"26\" text=\"11월\"/><Cell row=\"1\" col=\"27\" text=\"12월\"/><Cell row=\"1\" col=\"28\" text=\"1월\"/><Cell row=\"1\" col=\"29\" text=\"2월\"/><Cell row=\"1\" col=\"30\" text=\"3월\"/><Cell row=\"1\" col=\"31\" text=\"4월\"/><Cell row=\"1\" col=\"32\" text=\"5월\"/><Cell row=\"1\" col=\"33\" text=\"6월\"/><Cell row=\"1\" col=\"34\" text=\"7월\"/><Cell row=\"1\" col=\"35\" text=\"8월\"/><Cell row=\"1\" col=\"36\" text=\"9월\"/><Cell row=\"1\" col=\"37\" text=\"10월\"/><Cell row=\"1\" col=\"38\" text=\"11월\"/><Cell row=\"1\" col=\"39\" text=\"12월\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/><Cell col=\"9\"/><Cell col=\"10\"/><Cell col=\"11\"/><Cell col=\"12\"/><Cell col=\"13\"/><Cell col=\"14\"/><Cell col=\"15\"/><Cell col=\"16\" text=\"bind:Column0\"/><Cell col=\"17\" text=\"bind:Column1\"/><Cell col=\"18\" text=\"bind:Column2\"/><Cell col=\"19\" text=\"bind:Column3\"/><Cell col=\"20\" text=\"bind:Column4\"/><Cell col=\"21\" text=\"bind:Column5\"/><Cell col=\"22\" text=\"bind:Column6\"/><Cell col=\"23\" text=\"bind:Column7\"/><Cell col=\"24\" text=\"bind:Column8\"/><Cell col=\"25\" text=\"bind:Column9\"/><Cell col=\"26\" text=\"bind:Column10\"/><Cell col=\"27\" text=\"bind:Column11\"/><Cell col=\"28\" text=\"bind:Column12\"/><Cell col=\"29\" text=\"bind:Column13\"/><Cell col=\"30\" text=\"bind:Column14\"/><Cell col=\"31\" text=\"bind:Column15\"/><Cell col=\"32\" text=\"bind:Column16\"/><Cell col=\"33\" text=\"bind:Column17\"/><Cell col=\"34\" text=\"bind:Column18\"/><Cell col=\"35\" text=\"bind:Column19\"/><Cell col=\"36\" text=\"bind:Column20\"/><Cell col=\"37\" text=\"bind:Column21\"/><Cell col=\"38\" text=\"bind:Column22\"/><Cell col=\"39\" text=\"bind:Column23\"/></Band></Format></Formats>");
            ...
            obj = new Static("Static00","0","20","231","24",null,null,null,null,null,null,this.Div01_00.form);
            obj.set_taborder("2");
            obj.set_text("신규계약 매출 및 변동비 산출 상세");
        ...
        this.loadIncludeScript("BP10060T04.xfdl");
