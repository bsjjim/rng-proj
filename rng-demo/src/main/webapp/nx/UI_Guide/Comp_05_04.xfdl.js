(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Tab - 탭 내 스크롤이 생길경우");
            ...
            obj = new Div("Div00","0","0",null,null,"10","0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Div("Div00_00","0","319",null,null,"10","-319",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            obj.set_cssclass("div_group");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","0","18","120","30",null,null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("0");
            obj.set_text("마스터그리드");
            obj.set_cssclass("sta_WF_title1");
            ...
            obj = new Static("Static02",null,"20","15","24","307",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("3");
            obj.set_text("건");
            obj.set_cssclass("sta_WF_gridCount");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Static("Static02_00",null,"20","70","24","323",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("4");
            obj.set_text("4");
            obj.set_cssclass("sta_WF_gridCountNum");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Static("Static01_00_01",null,"-2","15","60","236",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("5");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static02_02",null,"20","50","24","250",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("6");
            obj.set_text("[단위:원]");
            obj.set_cssclass("sta_WF_gridCount");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_01",null,"3","10","47","298",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("7");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_01_01_00",null,"8","5","47","318",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("8");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("Button00_00_01_00_03_00",null,"20","76","24","160",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("9");
            obj.set_text("행추가");
            obj.set_cssclass("btn_Block_addRow");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02",null,"20","76","24","80",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("10");
            obj.set_text("행복사");
            obj.set_cssclass("btn_Block_copyRow");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02_00",null,"20","76","24","0",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("11");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_Block_delRow");
            this.Div00_00.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00_01_00","820","105","435","60",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("세로 스크롤이 생기는 탭은 탭페이지 우측에 10px 여백을 둔다.\r\n탭 내 가로스크롤을 허용하지 않는다.");
        ...
        // User Script
        this.registerScript("Comp_05_04.xfdl", function() {
        ...
        this.loadIncludeScript("Comp_05_04.xfdl");
