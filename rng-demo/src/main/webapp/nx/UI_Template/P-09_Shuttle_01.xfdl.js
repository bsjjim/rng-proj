(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00","Div01:15","38.46%","20","225",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Div00");
            obj.set_cssclass("div_group");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"전체\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"메뉴ID\"/><Cell col=\"2\" text=\"메뉴명\"/><Cell col=\"3\" text=\"분류\"/></Band><Band id=\"body\"><Cell text=\"bind:전체\"/><Cell col=\"1\" text=\"bind:메뉴ID\"/><Cell col=\"2\" text=\"bind:메뉴명\"/><Cell col=\"3\" text=\"bind:분류\"/></Band></Format></Formats>");
            this.Div02.addChild(obj.name, obj);
            ...
            obj = new Static("Static01","265","18","53","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("1");
            obj.set_text("메뉴명");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00_00_00_02",null,null,"480","90","227","381",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("<fc v=\"red\">좌우 그리드 같은비율 리사이징</fc>\r\n1. 첫번째 좌측 div_group 너비를 %로 지정\r\n2. 가운데 버튼영역 div의 left를 좌측 div_group  기준으로 앵커를 건다.\r\n3. 우측그리드의 left를 좌측 div_group  기준으로 앵커를 건다");
        ...
        {
            this.Static01_00_00_00_00_02.addEventHandler("onclick",this.Static01_00_00_00_00_onclick,this);
        };
        this.loadIncludeScript("P-09_Shuttle_01.xfdl");
