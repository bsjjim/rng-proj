(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("계정별/부서별 예산집행");
            ...
            obj = new Combo("Combo01","408","18","85","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("7");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var DivSearch_form_Combo01_innerdataset = new nexacro.NormalDataset("DivSearch_form_Combo01_innerdataset", obj);
            DivSearch_form_Combo01_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">소계정별</Col><Col id=\"datacolumn\">소계정별</Col></Row><Row><Col id=\"codecolumn\">대계정별</Col><Col id=\"datacolumn\">대계정별</Col></Row></Rows>");
            ...
            obj = new Static("Static00_00_00","533","18","53","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("8");
            obj.set_text("계정명");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_01_00_00_00","398","4","10","50",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("9");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_01_00","493","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("10");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Edit("Edit00_01_00_01_01_00_01_00_00","706","18","155","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("11");
            obj.set_text("P12345");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_01_00_00_00","679","18","24","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("12");
            obj.set_cssclass("btn_Comp_src");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_02_00_01_00_00","591","18","86","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("13");
            ...
            obj.set_text("분기별");
            obj.set_url("CO::CO00220T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("월별");
            obj.set_url("CO::CO00220T02.xfdl");
            this.Tab00.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        {
            this._addPreloadList("fdl","CO::CO00220T01.xfdl");
            this._addPreloadList("fdl","CO::CO00220T02.xfdl");
        };
        
        // User Script
        this.registerScript("CO00220.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.DivSearch.form.Static00_00_00.addEventHandler("onclick",this.DivSearch_Static00_00_00_onclick,this);
            this.Tab00.addEventHandler("onchanged",this.Tab00_onchanged,this);
        };
        this.loadIncludeScript("CO00220.xfdl");
