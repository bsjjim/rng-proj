(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("Combo00","635","18","100","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("8");
            obj.set_value("선택");
            obj.set_index("-1");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00","869","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("9");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_01_00","909","18","98","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("10");
            obj.set_text("계약종료 구분");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Combo("Combo00_00","1004","18","100","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("11");
            obj.set_text("선택");
            obj.set_value("선택");
            obj.set_index("-1");
            ...
            obj = new Static("Static01_00_00_00_02_00","625","6","10","50",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("15");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Combo("Combo00_01","739","18","130","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("22");
            obj.set_value("선택");
            obj.set_index("-1");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Combo("Combo00_02","86","52","80","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("24");
            obj.set_text("만기일자");
            obj.set_value("선택");
            obj.set_index("-1");
            ...
            obj = new CalPeriod("CalPeriod00","168","52","210","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("25");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Button("Button00_00_01_02_01_00_00_01",null,"10","103","28","396",null,null,null,null,null,this.div00.form);
            obj.set_taborder("1");
            obj.set_text("미리보기");
            obj.set_cssclass("btn_Comm_func_pop");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_02_00_00_00_00_01",null,"10","116","28","92",null,null,null,null,null,this.div00.form);
            obj.set_taborder("2");
            obj.set_text("만기처리 취소");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_02_00_00_01",null,"10","88","28","304",null,null,null,null,null,this.div00.form);
            obj.set_taborder("3");
            obj.set_text("담보해지");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_02_00_00_01_00",null,"10","88","28","212",null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_text("만기처리");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_02_00_00_01_00_00",null,"10","88","28","0",null,null,null,null,null,this.div00.form);
            obj.set_taborder("5");
            obj.set_text("엑셀출력");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("SD31012.xfdl", function() {
        ...
        this.loadIncludeScript("SD31012.xfdl");
