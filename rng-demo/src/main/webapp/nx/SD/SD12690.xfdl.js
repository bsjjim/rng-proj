(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("협력사 제품등록(이마트)");
            ...
            obj = new Div("Div01","0","63",null,null,"460","0",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Div01");
            ...
            obj = new Div("Div00",null,"62","400",null,"40","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            obj.set_cssclass("div_group");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button00_00_01_00_03_02",null,"20","62","24","108",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("24");
            obj.set_text("초기화");
            ...
            obj = new Button("Button00_00_01_00_03_02_01",null,"20","50","24","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("26");
            obj.set_text("삭제");
            obj.set_cssclass("btn_Block");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01","134","55","156","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("27");
            obj.set_text("21YHOTY");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button01","292","55","75","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("28");
            obj.set_text("중복확인");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit00_01_00_02_00_01_00_01","134","121","80","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("30");
            obj.set_text("123456789");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_01_00_00_01","216","121","24","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("31");
            obj.set_cssclass("btn_Comp_src");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_01_00_01_00_01","243","121","115","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("32");
            obj.set_text("서진아이앤디(주)");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("Combo00_00","134","154","155","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("33");
            obj.set_value("");
            obj.set_index("-1");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("Combo00_00_00","134","187","155","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("34");
            obj.set_text(" ");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Edit("Edit00_01_00","134","220","156","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("35");
            obj.set_text("21YHOTY");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button01_00","292","220","75","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("36");
            obj.set_text("중복확인");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_00","134","253","156","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("37");
            obj.set_text("21YHOTY");
            this.Div00.addChild(obj.name, obj);

            obj = new Radio("rad00","134","319","200","24",null,null,null,null,null,null,this.Div00.form);
            ...
            Div00_form_rad00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">예</Col><Col id=\"codecolumn\">예</Col></Row><Row><Col id=\"datacolumn\">아니오</Col><Col id=\"codecolumn\">아니오</Col></Row></Rows>");
            obj.set_innerdataset(Div00_form_rad00_innerdataset);
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_00_00","134","286","156","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("39");
            obj.set_text("21YHOTY");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00","521","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("3");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00","561","18","65","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("4");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Combo("Combo00_00","401","18","120","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("13");
            obj.set_text("김치냉장고");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Static("Static01_00_02_00_00","618","-1","10","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("14");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Combo("cmb00","628","18","100","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("15");
            obj.set_text("전체");
            this.DivSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("SD12690.xfdl", function() {
        ...
        this.loadIncludeScript("SD12690.xfdl");
