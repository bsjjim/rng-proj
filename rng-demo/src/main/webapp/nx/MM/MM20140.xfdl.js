(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("(대외계)차량등록증조회");
            ...
            obj = new Static("Static01_00_00_01","364","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00_00_01","404","18","63","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("5");
            obj.set_text("입고기간");
            obj.set_cssclass("sta_SA_label_req");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00","721","18","100","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("6");
            obj.set_text("등록증등록여부");
            obj.set_cssclass("sta_SA_label_req");
            this.div00.addChild(obj.name, obj);

            obj = new CalPeriod("CalPeriod00","472","18","210","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("7");
            obj.set_cssclass("input_req");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00_01","825","18","95","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("8");
            ...
            obj = new Static("Static01_00_00_00_01","172","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("9");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Edit("Edit00_00_00_00_00","87","18","85","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("12");
            obj.set_cssclass("input_req");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00_00","212","18","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("13");
            obj.set_text("차량번호");
            obj.set_cssclass("sta_SA_label_req");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_00_00_00_00_00","279","18","85","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("14");
            obj.set_cssclass("input_req");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);
            ...
            obj = new Button("Button00_00_01_00",null,"10","79","28","0",null,null,null,null,null,this.div00_00.form);
            obj.set_taborder("5");
            obj.set_text("인쇄");
        ...
        this.loadIncludeScript("MM20140.xfdl");
