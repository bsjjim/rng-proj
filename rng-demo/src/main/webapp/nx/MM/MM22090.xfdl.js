(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00_00_00","610","18","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("6");
            obj.set_text("번호구분");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit00_00_00_00","759","18","85","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("8");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00","428","18","63","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("9");
            obj.set_text("진행상태");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_01","495","18","75","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("10");
            ...
            obj = new Combo("cmb00_00_00_01","677","18","80","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("11");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static01_00_00_00_01","570","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("13");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static02_00_01",null,"20","50","24","813",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("7");
            obj.set_text("0");
            obj.set_cssclass("sta_WF_gridCountNum");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_02_00",null,"20","15","24","797",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("8");
            obj.set_text("건");
            obj.set_cssclass("sta_WF_gridCount");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_01_00_00_03_01","689","0","15","50",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_text("15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_01_01_00",null,"0","5","50","809",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("10");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("Button00_00_01_00_02_02_00_00_01_00",null,"20","44","24","740",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("11");
            obj.set_cssclass("btn_Block_excelUp");
            obj.set_tooltiptext("엑셀업로드");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_02_02_00_00_00_00_00",null,"20","44","24","692",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("12");
            obj.set_cssclass("btn_Block_excelDown");
            obj.set_tooltiptext("엑셀다운로드");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_02_00",null,"20","98","24","590",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("13");
            obj.set_text("양식다운로드");
            obj.set_cssclass("btn_Block");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_01_00",null,"20","74","24","102",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("14");
            obj.set_text("해지확인");
            obj.set_cssclass("btn_Block");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Button("Button00_00_01_00_03_01_00_01",null,"20","86","24","500",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("16");
            obj.set_text("등록증다운");
            obj.set_cssclass("btn_Block");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00",null,"20","76","24","420",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("17");
            obj.set_text("행추가");
            obj.set_cssclass("btn_Block_addRow");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02",null,"20","76","24","340",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("18");
            obj.set_text("행복사");
            obj.set_cssclass("btn_Block_copyRow");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02_00",null,"20","76","24","260",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("19");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_Block_delRow");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_00",null,"20","76","24","180",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("20");
            obj.set_text("행취소");
        ...
        this.loadIncludeScript("MM22090.xfdl");
