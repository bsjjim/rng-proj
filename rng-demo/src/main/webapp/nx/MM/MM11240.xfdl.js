(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("(EWS)등록대비 투입지연");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"경유지\"/><Cell col=\"2\" text=\"경유지명\"/><Cell col=\"3\" text=\"계약지점\"/><Cell col=\"4\" text=\"계약지점명\"/><Cell col=\"5\" text=\"발주일자\"/><Cell col=\"6\" text=\"입고일자\"/><Cell col=\"7\" text=\"등록일자\"/><Cell col=\"8\" text=\"투입일자\"/><Cell col=\"9\" text=\"차량번호\"/><Cell col=\"10\" text=\"계약시작일자\"/><Cell col=\"11\" text=\"종료예정일자\"/><Cell col=\"12\" text=\"계약번호\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column4\"/><Cell col=\"5\" text=\"bind:Column5\"/><Cell col=\"6\" text=\"bind:Column6\"/><Cell col=\"7\" text=\"bind:Column7\"/><Cell col=\"8\" text=\"bind:Column8\"/><Cell col=\"9\" text=\"bind:Column9\"/><Cell col=\"10\"/><Cell col=\"11\"/><Cell col=\"12\"/></Band></Format></Formats>");
            this.divGridWapper.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("MM11240.xfdl", function() {
        ...
        this.loadIncludeScript("MM11240.xfdl");
