(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_00","489","0","100","50",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("1");
            obj.set_text("h50");
            ...
            obj = new Static("Static02_00_00_00_00_00_02","80","20","143","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("5");
            obj.set_text("오류건수/업로드대상건수");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00","221","20","50","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("6");
            obj.set_text("0/0");
            ...
            obj = new Static("Static01_00_00_01_00_00_03_01",null,"0","15","50","374",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_text("15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("Button00_00_01_00_03_01_00_01",null,"20","122","24","54",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("13");
            obj.set_text("오류내역다운로드");
            obj.set_cssclass("btn_Block");
            this.Div01.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_01_00_01_00",null,"20","98","24","180",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("14");
            obj.set_text("양식다운로드");
            obj.set_cssclass("btn_Block");
            this.Div01.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("MM20215T02.xfdl");
