(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnOk","107",null,"76","28",null,"21",null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("예");
            ...
            obj = new Button("btnCancel","btnOk:4",null,"76","28",null,"21",null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("아니오");
            obj.set_cssclass("btn_Block");
            obj.set_borderRadius("2px");
        ...
        // User Script
        this.registerScript("PopupConfirm.xfdl", function() {
        /********************************************************************
        *  Alert메시지용 팝업
        ...
        * FORM EVENT 영역(onload)
        ...
        this.fnFormOnload = function(obj,e)
        {
        	...
        	if(this.staMsg._width > 350)
        	{
        		...
        		var nBtnLeft = (obj.getOwnerFrame().width / 2) - Math.round(156 / 2);
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("PopupConfirm.xfdl");
