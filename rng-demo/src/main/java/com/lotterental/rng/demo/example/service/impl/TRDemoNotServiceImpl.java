...
@Slf4j
@Service
public class TRDemoNotServiceImpl implements TRDemoNotService {
    ...
    public void insertRequired() {
        ...
        trDemoModel.setName("requirednot");
        trDemoMapper.insertRequired(trDemoModel);
        trDemoModel.setName("requiredChildrennot");
        trDemoChildService.insertRequiredChildren(trDemoModel);
        trDemoModel.setName("required2not");
        trDemoMapper.insertRequired(trDemoModel);
