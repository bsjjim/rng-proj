(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"차고지명\"/><Cell col=\"2\" text=\"차고지코드\"/><Cell col=\"3\" text=\"조직코드\"/><Cell col=\"4\" text=\"조직Lv1명\"/><Cell col=\"5\" text=\"조직Lv2명\"/><Cell col=\"6\" text=\"가동시간(평일)\"/><Cell col=\"7\" text=\"가동시간(휴일)\"/><Cell col=\"8\" text=\"가동시간(전체)\"/><Cell col=\"9\" text=\"가동가능시간(평일)\"/><Cell col=\"10\" text=\"가동가능시간(휴일)\"/><Cell col=\"11\" text=\"가동가능시간(전체)\"/><Cell col=\"12\" text=\"가동률(평일)\"/><Cell col=\"13\" text=\"가동률(휴일)\"/><Cell col=\"14\" text=\"가동률(전체)\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/><Cell col=\"9\"/><Cell col=\"10\"/><Cell col=\"11\"/><Cell col=\"12\"/><Cell col=\"13\"/><Cell col=\"14\"/></Band></Format></Formats>");
            ...
            obj.set_taborder("0");
            obj.set_binddataset("ds_grid");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"일\"/><Cell col=\"2\" text=\"차고지코드\"/><Cell col=\"3\" text=\"차고지명\"/><Cell col=\"4\" text=\"시도\"/><Cell col=\"5\" text=\"구군\"/><Cell col=\"6\" text=\"차량수\"/><Cell col=\"7\" text=\"총영업시간\"/><Cell col=\"8\" text=\"가동시간(전체)\"/><Cell col=\"9\" text=\"가동시간(회원)\"/><Cell col=\"10\" text=\"가동시간(직원)\"/><Cell col=\"11\" text=\"가동률(회원)\"/><Cell col=\"12\" text=\"가동률(전체)\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/><Cell col=\"9\"/><Cell col=\"10\"/><Cell col=\"11\"/><Cell col=\"12\"/></Band></Format></Formats>");
            ...
            obj = new Static("Static00","0","20","216","24",null,null,null,null,null,null,this.Div01_00.form);
            obj.set_taborder("2");
            obj.set_text("SPOT별 가동시간 내역 업로드");
            obj.set_cssclass("sta_WF_title2");
            this.Div01_00.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("BP10420T03.xfdl");
