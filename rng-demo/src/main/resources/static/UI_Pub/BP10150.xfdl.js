(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("고정비");
            obj.set_url("BP::BP10150T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("실적추정");
            obj.set_url("BP::BP10150T02.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10150T01.xfdl");
            this._addPreloadList("fdl","BP::BP10150T02.xfdl");
        };
        
        // User Script
        this.registerScript("BP10150.xfdl", function() {
        ...
        this.loadIncludeScript("BP10150.xfdl");
