(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("보험사고 기초데이터 조회");
            ...
            obj = new Static("Static00_00_00","668","18","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("6");
            obj.set_text("번호구분");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit00_00_00_00","817","18","85","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("8");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00_01","735","18","80","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("9");
            ...
            obj = new Static("Static01_00_00_00_01","628","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("10");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_00_01_00","902","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("11");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00_00_00_00","352","18","50","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("12");
            obj.set_text("보험사");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00_01_00","418","18","210","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("13");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Edit("Edit00_01_00_00_00","1034","18","80","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("14");
            obj.set_text("123406789");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_00_00","1116","18","24","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("15");
            obj.set_cssclass("btn_Comp_src");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00_00","1143","18","115","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("16");
            obj.set_text("김나나");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00","942","18","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("17");
            obj.set_text("고객번호");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_02_00","86","52","42","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("18");
            obj.set_text("3666");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_01_00","130","52","24","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("19");
            obj.set_cssclass("btn_Comp_src");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_01_00","157","52","155","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("20");
            ...
            obj = new Static("Static00_00_00_00_00_00","352","52","60","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("22");
            obj.set_text("회계기간");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new CalPeriodMonth("CalPeriodMonth00","418","52","170","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("23");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_02","668","52","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("24");
            obj.set_text("계약번호");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00","735","52","85","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("25");
            obj.set_text("2021012012");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00_01","942","52","90","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("26");
            obj.set_text("사고접수번호");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_02_00_00","1034","52","100","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("27");
        ...
        this.loadIncludeScript("MM20100.xfdl");
