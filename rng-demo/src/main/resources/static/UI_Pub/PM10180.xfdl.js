(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_00","226","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("2");
            obj.set_text("w40");
            ...
            obj = new Static("Static01_01","422","18","39","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("3");
            obj.set_text("주소");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00","382","0","40","45",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("4");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_00_00","705","-2","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("6");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_01_00_00","745","18","59","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("9");
            obj.set_text("조회시점");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("MaskEdit00_00_00_00_00_00","332","18","50","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("11");
            ...
            obj = new Edit("Edit00_01_00_01_01_00_00","463","18","242","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("12");
            obj.set_text("P12345");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Radio("rad00","812","18","200","24",null,null,null,null,null,null,this.DivSearch.form);
            ...
            obj = new Radio("rad00_00","1056","18","200","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_initvalueid("iv_Radio");
            obj.set_taborder("14");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static01_01_00_00_00","989","18","59","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("15");
            obj.set_text("배정여부");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00_00","949","-2","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("16");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00",null,"20","43","24","385",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_text("MOT");
            obj.set_cssclass("sta_SA_label");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("cmb00",null,"20","160","24","222",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            obj.set_text("그린카 정비지원 PART");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Static("Static00_00_00",null,"20","63","24","549",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("11");
            obj.set_text("시작일자");
            obj.set_cssclass("sta_SA_label");
            this.Div00.addChild(obj.name, obj);

            obj = new Calendar("cal00",null,"20","105","24","441",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("12");
            ...
            obj = new Static("Static01_00_00_01_00_00_03_01_00_00",null,"17","20","30","421",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("14");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
        ...
        this.loadIncludeScript("PM10180.xfdl");
