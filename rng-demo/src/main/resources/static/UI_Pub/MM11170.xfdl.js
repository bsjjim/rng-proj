(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_00_00_00","853","10","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("9");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Combo("cmb04","402","52","224","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("11");
            ...
            obj = new Edit("Edit00_00_00_00","733","18","120","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("18");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_01_01_00","893","18","61","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("19");
            obj.set_text("차량번호");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_00_00_00_00","961","18","120","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("20");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"No\"/><Cell col=\"1\" rowspan=\"2\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" rowspan=\"2\" text=\"발주번호\"/><Cell col=\"3\" rowspan=\"2\" text=\"공급업체\" cssclass=\"cell_fix\"/><Cell col=\"4\" colspan=\"3\" text=\"선급금-차량구매\"/><Cell col=\"7\" colspan=\"4\" text=\"자본적지출-차량가\"/><Cell col=\"11\" colspan=\"2\" text=\"선금 반제\"/><Cell col=\"13\" colspan=\"2\" text=\"출금\"/><Cell row=\"1\" col=\"4\" text=\"전표번호\"/><Cell row=\"1\" col=\"5\" text=\"전기일자\"/><Cell row=\"1\" col=\"6\" text=\"금액\"/><Cell row=\"1\" col=\"7\" text=\"전표번호\"/><Cell row=\"1\" col=\"8\" text=\"전기일자\"/><Cell row=\"1\" col=\"9\" text=\"금액\"/><Cell row=\"1\" col=\"10\" text=\"전자세금계산서번호\"/><Cell row=\"1\" col=\"11\" text=\"전표번호\"/><Cell row=\"1\" col=\"12\" text=\"전기일자\"/><Cell row=\"1\" col=\"13\" text=\"전표번호\"/><Cell row=\"1\" col=\"14\" text=\"전기일자\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:Column1\"/><Cell col=\"3\" text=\"bind:Column2\" cssclass=\"cell_fix\"/><Cell col=\"4\" text=\"bind:Column3\"/><Cell col=\"5\" text=\"bind:Column4\"/><Cell col=\"6\" text=\"bind:Column5\"/><Cell col=\"7\" text=\"bind:Column6\"/><Cell col=\"8\" text=\"bind:Column7\"/><Cell col=\"9\" text=\"bind:Column8\"/><Cell col=\"10\" text=\"bind:Column9\"/><Cell col=\"11\"/><Cell col=\"12\"/><Cell col=\"13\"/><Cell col=\"14\"/></Band></Format></Formats>");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static02_00_00_00_00_00_02","86","20","58","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("5");
            obj.set_text("선택건수");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static02_00_00","137","20","50","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("6");
            obj.set_text("0");
