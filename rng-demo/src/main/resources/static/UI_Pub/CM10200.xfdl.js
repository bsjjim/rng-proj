(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01","315","18","58","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("1");
            obj.set_text("공지유형");
            ...
            obj = new Static("Static01_00_00","275","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("3");
            obj.set_text("w40");
            ...
            obj = new Static("Static01_00_00_00","591","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("6");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Combo("Combo00_00","74","18","201","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("7");
            ...
            obj = new Static("Static01_00_00_00_02","371","5","10","50",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("9");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_01","631","18","63","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("10");
            obj.set_text("공지기간");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_02_00","688","5","10","50",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("11");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00","948","18","38","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("12");
            obj.set_text("제목");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Edit("edt00_00_01","990","18","201","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("13");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Combo("cmb00","381","18","210","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("15");
            obj.set_text("모바일전체(순회,카메니저)");
            obj.set_value("");
            obj.set_index("-1");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CalPeriod("CalPeriod00","698","18","210","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("16");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_00","74","52","57","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("17");
            obj.set_value("P12345");
            obj.set_text("P12345");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_00","133","52","24","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("18");
            obj.set_cssclass("btn_Comp_src");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00","160","52","115","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("19");
            obj.set_value("홍길순");
            obj.set_text("홍길순");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_01_00","315","52","63","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("20");
            obj.set_text("등록기간");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new CalPeriod("CalPeriod00_00","381","50","210","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("21");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00","908","-10","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("22");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"공지번호\"/><Cell col=\"2\" text=\"공지시작\"/><Cell col=\"3\" text=\"공지종료\"/><Cell col=\"4\" text=\"공지유형\"/><Cell col=\"5\" text=\"제목\"/><Cell col=\"6\" text=\"등록자\"/><Cell col=\"7\" text=\"등록일\"/><Cell col=\"8\" text=\"조회수\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/></Band></Format></Formats>");
            this.divGridWapper.addChild(obj.name, obj);
            ...
            obj = new Div("div00","0","800",null,"48","40",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("div00");
            ...
            obj = new Div("div01",null,"DivSearch:0","734","254","40",null,null,null,null,null,this);
            obj.set_text("Div01");
            obj.set_cssclass("div_group");
            obj.set_taborder("4");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cmb00","500","89","120","24",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("14");
            obj.set_cssclass("input_req");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static26_02_00_00_00","0","183","130","71",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("17");
            obj.set_text("내용");
            obj.set_cssclass("sta_DA_label");
            this.div01.addChild(obj.name, obj);

            obj = new Static("Static27_03_00_00_00","129","183",null,"71","0",null,null,null,null,null,this.div01.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_DA_data");
            obj.set_text("");
            this.div01.addChild(obj.name, obj);

            obj = new CalPeriod("CalPeriod00","134","122","210","24",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("19");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("mae00","134","89","120","24",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("23");
            this.div01.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00_00","134","155",null,"24","5",null,null,null,null,null,this.div01.form);
            obj.set_taborder("24");
            obj.set_text("홍길순");
            this.div01.addChild(obj.name, obj);

            obj = new TextArea("txt00","134","188",null,"61","5",null,null,null,null,null,this.div01.form);
            obj.set_taborder("25");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new Div("div02",null,"div01:0","734","165","40",null,null,null,null,null,this);
            obj.set_text("Div00");
            obj.set_cssclass("div_group");
            obj.set_taborder("6");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"98\"/><Column size=\"547\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"theme://images/flag.png\" displaytype=\"imagecontrol\"/><Cell col=\"1\" text=\"Column1\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"2\" text=\"정책그룹ID\"/><Cell col=\"3\" text=\"정책그룹명\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/></Band></Format></Formats>");
            this.div02.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_01_00_00_03_01_00_00_00_00","1234","44","100","6",null,null,null,null,null,null,this.div02.form);
            obj.set_taborder("2");
            obj.set_text("6");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_00_01","-4","39","145","11",null,null,null,null,null,null,this.div02.form);
            obj.set_taborder("3");
            obj.set_text("11");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("Button00_00_01_00_03_02",null,"20","112","24","78",null,null,null,null,null,this.div02.form);
            obj.set_taborder("4");
            obj.set_text("정책그룹선택");
            obj.set_cssclass("btn_Block_popup");
            this.div02.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02_00",null,"20","76","24","0",null,null,null,null,null,this.div02.form);
            obj.set_taborder("5");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_Block_delRow");
            this.div02.addChild(obj.name, obj);

            obj = new Div("div01_00",null,"div02:0","734","119","40",null,null,null,null,null,this);
            obj.set_text("Div01");
            obj.set_cssclass("div_group");
            obj.set_taborder("7");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00_01_00_00_03_01_00_00_00_00","629","44","100","6",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("9");
            obj.set_text("6");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Edit("Edit00_01_00_01_00_00","134","56",null,"24","372",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("12");
            obj.set_text("홍길순");
            this.div01_00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00_00_00","134","89",null,"24","372",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("13");
            obj.set_text("홍길순");
            this.div01_00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00_00_00_00","500","89",null,"24","6",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("14");
            obj.set_text("홍길순");
            this.div01_00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00_00_01","500","56",null,"24","6",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("15");
            obj.set_text("홍길순");
            this.div01_00.addChild(obj.name, obj);

            obj = new Div("div02_00",null,"635","734","165","40",null,null,null,null,null,this);
            obj.set_text("Div00");
            obj.set_cssclass("div_group");
            obj.set_taborder("8");
            this.addChild(obj.name, obj);
            ...
            obj.set_binddataset("Dataset00");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"180\"/><Column size=\"180\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"theme://images/flag.png\" displaytype=\"imagecontrol\"/><Cell col=\"1\" text=\"Column1\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"2\" text=\"파일번호\"/><Cell col=\"3\" text=\"순번\"/><Cell col=\"4\" text=\"파일경로\"/><Cell col=\"5\" text=\"파일명\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\"/><Cell col=\"5\"/></Band></Format></Formats>");
            this.div02_00.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("CM10200.xfdl", function() {
        ...
        this.loadIncludeScript("CM10200.xfdl");
