(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_00_00_00",null,"0","10","50","268",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("6");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Radio("Radio00",null,"20","230","24","239",null,null,null,null,null,this.Div01.form);
        ...
        this.loadIncludeScript("BP10350T01.xfdl");
