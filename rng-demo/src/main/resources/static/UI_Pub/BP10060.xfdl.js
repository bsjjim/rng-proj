(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("신규계약 매출 및 변동비 산출");
            ...
            obj.set_text("신규장기_투입대수");
            obj.set_url("BP::BP10060T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("신규장기_대여료");
            obj.set_url("BP::BP10060T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("단기");
            obj.set_url("BP::BP10060T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("매출/변동비");
            obj.set_url("BP::BP10060T04.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage5",this.Tab00);
            obj.set_text("인원수");
            obj.set_url("BP::BP10060T05.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage6",this.Tab00);
            obj.set_text("인건비 산출");
            obj.set_url("BP::BP10050T06.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10060T01.xfdl");
            this._addPreloadList("fdl","BP::BP10060T02.xfdl");
            this._addPreloadList("fdl","BP::BP10060T03.xfdl");
            this._addPreloadList("fdl","BP::BP10060T04.xfdl");
            this._addPreloadList("fdl","BP::BP10060T05.xfdl");
            this._addPreloadList("fdl","BP::BP10050T06.xfdl");
        };
        
        // User Script
        this.registerScript("BP10060.xfdl", function() {
        ...
        this.loadIncludeScript("BP10060.xfdl");
