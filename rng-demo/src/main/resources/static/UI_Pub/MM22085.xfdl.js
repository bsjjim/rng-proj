(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_00_00","942","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("6");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00_00","1129","18","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("7");
            obj.set_text("차대번호");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit00_00_00_00","1197","18","85","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("9");
            obj.set_text("123허1234");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00","792","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("10");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00_00_00","625","18","40","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("11");
            obj.set_text("계약");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00","667","18","125","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("12");
            ...
            obj.set_text("리스(이용자부보_");
            obj.set_index("0");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00_00","832","18","40","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("13");
            obj.set_text("연령");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00_00","872","18","70","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("14");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static00_00","443","18","63","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("15");
            obj.set_text("진행상태");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_01","510","18","75","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("16");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static00_00_00_00_01","982","18","40","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("17");
            obj.set_text("차량");
            obj.set_cssclass("sta_SA_label");
            this.div00.addChild(obj.name, obj);

            obj = new Combo("cmb00_00_00_01","1024","18","65","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("18");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Combo("cmb00_00_01_00","86","18","105","24",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("19");
            obj.set_text("보험만기일자");
            obj.set_index("-1");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_01","585","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("20");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_00_02","1089","0","40","60",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("21");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("Button00_00_01_00_03_02_00",null,"20","98","24","180",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("13");
            obj.set_text("양식다운로드");
        ...
        this.loadIncludeScript("MM22085.xfdl");
