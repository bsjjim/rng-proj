(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("총계");
            obj.set_url("SD::SD17130T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("롯데렌터카");
            obj.set_url("SD::SD17130T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("신차장다이렉트");
            obj.set_url("SD::SD17130T03.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage4",this.Tab00);
            obj.set_text("고객센터,기타");
            obj.set_url("SD::SD17130T04.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","SD::SD17130T01.xfdl");
            this._addPreloadList("fdl","SD::SD17130T02.xfdl");
            this._addPreloadList("fdl","SD::SD17130T03.xfdl");
            this._addPreloadList("fdl","SD::SD17130T04.xfdl");
        };
        
        // User Script
        this.registerScript("SD17130.xfdl", function() {
        ...
        this.loadIncludeScript("SD17130.xfdl");
