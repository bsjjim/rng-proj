(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("신규계약 매출 및 변동비 확정");
            ...
            obj.set_text("매출/변동비");
            obj.set_url("BP::BP10170T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("투자물량");
            obj.set_url("BP::BP10170T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("고정비 배부");
            obj.set_url("BP::BP10170T03.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10170T01.xfdl");
            this._addPreloadList("fdl","BP::BP10170T02.xfdl");
            this._addPreloadList("fdl","BP::BP10170T03.xfdl");
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.DivSearch.form.Static01.addEventHandler("onclick",this.DivSearch_Static01_onclick,this);
        };
        this.loadIncludeScript("BP10170.xfdl");
