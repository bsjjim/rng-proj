(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_00_01","456","38","40","60",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_00_00","1041","38","40","60",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00_00","1081","52","71","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("청구매니저");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00_00","1081","18","71","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("30");
            obj.set_text("영업매니저");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_00_00","1081","86","58","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("31");
            obj.set_text("청구구분");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_00","1162","52","57","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("32");
            obj.set_text("P12345");
            this.divSearch.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_00","1221","52","24","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("33");
            obj.set_cssclass("btn_Comp_src");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00","1248","52","115","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("34");
            obj.set_text("홍길순");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_00_01","1162","18","57","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("35");
            obj.set_text("P12345");
            this.divSearch.addChild(obj.name, obj);

            obj = new Button("Button00_01_00_00_01","1221","18","24","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("36");
            obj.set_cssclass("btn_Comp_src");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_00_01","1248","18","115","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("37");
            obj.set_text("홍길순");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00_01_01_01","854","52","71","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("39");
            obj.set_text("청구서번호");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_00_01","961","52","80","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("40");
            obj.set_text("123456789");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static00_00_00_01_01_01_00","854","86","97","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("41");
            obj.set_text("세금계산서번호");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_00_01_00","961","86","80","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("42");
            obj.set_text("123456789");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00","814","55","40","60",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("43");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Combo("cmb00","590","18","120","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("44");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new MultiCombo("MultiCombo00","1162","86","220","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("45");
            obj.set_viewtype("B");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new CalPeriod("CalPeriod00","712","18","210","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("46");
            obj.set_cssclass("input_req");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Calendar("Calendar00_00",null,"20","105","24","672",null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("15");
            obj.set_dateformat("yyyy-MM-dd ");
            obj.set_value("20221001");
            this.divGridWapper.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00_00_02_00_00",null,"20","84","24","568",null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("16");
            obj.set_text("임의사용기간");
            obj.set_cssclass("sta_SA_label_req");
            this.divGridWapper.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00_01_00_00_00_00_00_00",null,"0","20","50","652",null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("20");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static02_00_00_00_00_00_02_00_00_00",null,"20","84","24","787",null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("22");
            obj.set_text("임의거래일자");
            obj.set_cssclass("sta_SA_label");
            this.divGridWapper.addChild(obj.name, obj);
            ...
            obj = new CalPeriod("CalPeriod00","930","20","210","24",null,null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("25");
            obj.set_cssclass("input_req");
            this.divGridWapper.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk00",null,"10","92","24","75",null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_text("영문으로출력");
            this.div00.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("SB10100.xfdl", function() {
        ...
        this.loadIncludeScript("SB10100.xfdl");
