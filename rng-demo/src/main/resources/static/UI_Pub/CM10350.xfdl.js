(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div01","0","0","734","261",null,null,null,null,null,null,this);
            obj.set_text("Div01");
            ...
            obj = new Radio("rad00","134","75","200","24",null,null,null,null,null,null,this.div01.form);
            ...
            div01_form_rad00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">Blue타입</Col><Col id=\"datacolumn\">Blue타입</Col></Row><Row><Col id=\"codecolumn\">Red타입</Col><Col id=\"datacolumn\">Red타입</Col></Row></Rows>");
            obj.set_innerdataset(div01_form_rad00_innerdataset);
            obj.set_text("Blue타입");
            obj.set_value("Blue타입");
            obj.set_index("0");
            this.div01.addChild(obj.name, obj);

            obj = new Static("Static26_00_00","366","69","130","34",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("27");
            obj.set_text("비밀번호 확인");
            obj.set_cssclass("sta_DA_label_req");
            this.div01.addChild(obj.name, obj);

            obj = new Edit("edt00_00","500","74","155","24",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("28");
            obj.set_cssclass("input_req");
            this.div01.addChild(obj.name, obj);

            obj = new Static("Static26_02_01_00_00","366","154","130","34",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("29");
            obj.set_text("부서팩스번호");
            obj.set_cssclass("sta_DA_label");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit00_01_00_01_00_00_00_00_00","500","159",null,"24","6",null,null,null,null,null,this.div01.form);
            obj.set_taborder("30");
            obj.set_text("홍길순");
            this.div01.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_01_00_00","-4","221","155","15",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("31");
            obj.set_text("15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00","0","230","400","24",null,null,null,null,null,null,this);
            obj.set_initvalueid("iv_fc_blue");
            obj.set_taborder("4");
            obj.set_text("※ HR정보의 변경은 HT정보 변경 화면에서 변경하시기 바랍니다.");
        ...
        // User Script
        this.registerScript("CM10350.xfdl", function() {
        ...
        this.loadIncludeScript("CM10350.xfdl");
