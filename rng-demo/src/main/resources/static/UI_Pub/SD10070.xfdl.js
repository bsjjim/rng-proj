(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"140\"/><Column size=\"100\"/><Column size=\"140\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"고객번호\"/><Cell col=\"2\" text=\"고객명\"/><Cell col=\"3\" text=\"고객유형\"/><Cell col=\"4\" text=\"회원등급\"/><Cell col=\"5\" text=\"고객상태\"/><Cell col=\"6\" text=\"처리일자\"/><Cell col=\"7\" text=\"처리사원\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column4\"/><Cell col=\"5\" text=\"bind:Column5\"/><Cell col=\"6\" text=\"bind:Column6\"/><Cell col=\"7\" text=\"bind:Column7\"/></Band></Format></Formats>");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00_00","663","0","40","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("3");
            obj.set_text("w40");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Radio("Radio00_00","771","18","311","24",null,null,null,null,null,null,this.DivSearch.form);
            ...
            DivSearch_form_Radio00_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">임의탈퇴</Col><Col id=\"datacolumn\">임의탈퇴</Col></Row><Row><Col id=\"codecolumn\">임의탈퇴예정</Col><Col id=\"datacolumn\">임의탈퇴예정</Col></Row><Row><Col id=\"codecolumn\">연장요청</Col><Col id=\"datacolumn\">연장요청</Col></Row></Rows>");
            obj.set_innerdataset(DivSearch_form_Radio00_00_innerdataset);
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_01","703","18","63","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("6");
            obj.set_text("탈퇴구분");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new CalPeriodDay("CalPeriodDay00","423","18","240","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("13");
            this.DivSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static27_00_02_01_00_02","129","282",null,"34","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_DA_data");
            obj.set_text("");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static27_00_02_01_00_01","129","315",null,"34","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("36");
            obj.set_cssclass("sta_DA_data");
            obj.set_text("");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static26_01_01_00_00_01","0","282","130","34",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("21");
            obj.set_text("최종 대여일");
            obj.set_cssclass("sta_DA_label");
            this.Div00.addChild(obj.name, obj);

            obj = new Calendar("Calendar00_00_00_00","134","254","120","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("22");
            obj.set_value("20221001");
            this.Div00.addChild(obj.name, obj);

            obj = new Calendar("Calendar00_00_00_01","135","287","120","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("23");
            obj.set_value("20221001");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit00_01_00_01_01_00_00_01_00","134","353",null,"24","4",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("24");
            obj.set_enable("true");
            obj.set_text("P12345");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_02",null,"20","98","24","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("25");
            obj.set_text("연장요청취소");
            obj.set_cssclass("btn_Block");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_02_00",null,"20","74","24","102",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("26");
            obj.set_text("연장요청");
            obj.set_cssclass("btn_Block");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_02_00_00",null,"20","98","24","180",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("27");
            obj.set_text("임의탈퇴취소");
            obj.set_cssclass("btn_Block");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_02_00_00_00",null,"20","98","24","282",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("28");
            obj.set_text("임의탈퇴처리");
            obj.set_cssclass("btn_Block");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_02_00_00_00_00",null,"20","62","24","384",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("29");
            obj.set_text("초기화");
            obj.set_cssclass("btn_Block");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static26_01_01_00_00_02","0","315","130","34",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("34");
            obj.set_text("최종 반납일");
            obj.set_cssclass("sta_DA_label");
            this.Div00.addChild(obj.name, obj);

            obj = new Calendar("Calendar00_00_00_00_00","134","320","120","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("35");
            obj.set_value("20221001");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Button("Button00",null,"10","112","28","208",null,null,null,null,null,this.div00.form);
            obj.set_taborder("0");
            obj.set_text("임의탈퇴취소");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_00",null,"10","88","28","116",null,null,null,null,null,this.div00.form);
            obj.set_taborder("1");
            obj.set_text("연장요청");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);
            ...
            obj = new Button("Button00_01",null,"10","112","28","324",null,null,null,null,null,this.div00.form);
            obj.set_taborder("5");
            obj.set_text("임의탈퇴처리");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);

            obj = new Button("Button00_01_00",null,"10","76","28","440",null,null,null,null,null,this.div00.form);
            obj.set_taborder("6");
            obj.set_text("초기화");
            obj.set_cssclass("btn_Comm_func");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static01_00_00","918","123","20","50",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("SD10070.xfdl", function() {
        ...
        this.loadIncludeScript("SD10070.xfdl");
