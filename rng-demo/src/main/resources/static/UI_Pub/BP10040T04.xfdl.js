(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div01","0","0",null,null,"0","50%",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div01");
            ...
            obj = new Static("Static00","0","20","226","24",null,null,null,null,null,null,this.Div01_00.form);
            obj.set_taborder("2");
            obj.set_text("기존장기계약 기타매출 산출 상세");
        ...
        this.loadIncludeScript("BP10040T04.xfdl");
