(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" text=\"No\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"상품구분내역\"/><Cell col=\"3\" text=\"구매의뢰번호\"/><Cell col=\"4\" text=\"품목번호\"/><Cell col=\"5\" text=\"계약번호\"/><Cell col=\"6\" text=\"계약지점\"/><Cell col=\"7\" text=\"관리지점\"/><Cell col=\"8\" text=\"구매의뢰수량\"/><Cell col=\"9\" text=\"발주가능수량\"/><Cell col=\"10\" text=\"기발주수량\"/><Cell col=\"11\" text=\"구매의뢰단가\"/><Cell col=\"12\" text=\"구매합가\"/><Cell col=\"13\" text=\"품목명\"/><Cell col=\"14\" text=\"품목코드\"/><Cell col=\"15\" text=\"대표모델\"/><Cell col=\"16\" text=\"공급업체명\"/><Cell col=\"17\" text=\"공급업체번호\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\" displaytype=\"imagecontrol\"/><Cell col=\"1\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"2\" text=\"bind:Column1\"/><Cell col=\"3\" text=\"bind:Column2\"/><Cell col=\"4\" text=\"bind:Column3\"/><Cell col=\"5\" text=\"bind:Column4\"/><Cell col=\"6\" text=\"bind:Column5\"/><Cell col=\"7\" text=\"bind:Column6\"/><Cell col=\"8\" text=\"bind:Column7\"/><Cell col=\"9\" text=\"bind:Column8\"/><Cell col=\"10\" text=\"bind:Column9\"/><Cell col=\"11\"/><Cell col=\"12\"/><Cell col=\"13\"/><Cell col=\"14\"/><Cell col=\"15\"/><Cell col=\"16\"/><Cell col=\"17\"/></Band></Format></Formats>");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00_00_00_01",null,"20","58","24","218",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_text("발주번호");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00_00_00_01_00",null,"20","38","24","411",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("11");
            obj.set_text("금액");
            obj.set_cssclass("sta_SA_label");
            this.Div01.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit00_00_00",null,"20","120","24","289",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("12");
            obj.set_format("#,##9");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("Edit00_00",null,"20","85","24","124",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("13");
            obj.set_text("2021012012");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_01_00",null,"0","20","60","269",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("14");
            obj.set_text("20");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
