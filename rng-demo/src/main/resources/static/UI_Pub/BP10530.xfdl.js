(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("인원수");
            obj.set_url("BP::BP10530T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("인건비 단가");
            obj.set_url("BP::BP10530T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("인건비 산출");
            obj.set_url("BP::BP10530T03.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","BP::BP10530T01.xfdl");
            this._addPreloadList("fdl","BP::BP10530T02.xfdl");
            this._addPreloadList("fdl","BP::BP10530T03.xfdl");
        };
        
        // User Script
        this.registerScript("BP10530.xfdl", function() {
        ...
        this.loadIncludeScript("BP10530.xfdl");
