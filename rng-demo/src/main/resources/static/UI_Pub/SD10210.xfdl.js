(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00_01_00_01",null,"1","10","60","1426",null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("4");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static00_00","326","18","63","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("9");
            obj.set_text("조회기간");
            obj.set_cssclass("sta_SA_label");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_00_01_00","383","0","10","60",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("10");
            obj.set_text("10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new CalPeriod("CalPeriod00_00","393","18","210","24",null,null,null,null,null,null,this.DivSearch.form);
            obj.set_taborder("11");
            this.DivSearch.addChild(obj.name, obj);

            obj = new Div("divGridWapper","0","63","48.04%",null,null,"48",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Div00");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\" theme://images/flag.png\" displaytype=\"imagecontrol\"/><Cell col=\"1\" rowspan=\"2\" text=\"Column1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" rowspan=\"2\" text=\"지점\"/><Cell col=\"3\" colspan=\"2\" text=\"적용기간\"/><Cell col=\"5\" colspan=\"3\" text=\"단가(원/1리터)\"/><Cell col=\"8\" rowspan=\"2\" text=\"요금적용여부\"/><Cell row=\"1\" col=\"3\" text=\"시작\"/><Cell row=\"1\" col=\"4\" text=\"종료\"/><Cell row=\"1\" col=\"5\" text=\"휘발유\"/><Cell row=\"1\" col=\"6\" text=\"디젤\"/><Cell row=\"1\" col=\"7\" text=\"LPG\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column4\"/><Cell col=\"5\" text=\"bind:Column5\"/><Cell col=\"6\" text=\"bind:Column6\"/><Cell col=\"7\" text=\"bind:Column7\"/><Cell col=\"8\"/></Band></Format></Formats>");
            this.divGridWapper.addChild(obj.name, obj);
            ...
            obj = new Static("Static02_02_00",null,"20","15","24","328",null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("4");
            obj.set_text("건");
            ...
            obj = new Tab("Tab00","divGridWapper:20","DivSearch:21",null,null,"40","48",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_tabindex("0");
            ...
            obj.set_text("아날로그");
            obj.set_url("SD::SD10210T01.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.Tab00);
            obj.set_text("디지털 12");
            obj.set_url("SD::SD10210T02.xfdl");
            this.Tab00.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage3",this.Tab00);
            obj.set_text("디지털 16");
            obj.set_url("SD::SD10210T03.xfdl");
            this.Tab00.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","SD::SD10210T01.xfdl");
            this._addPreloadList("fdl","SD::SD10210T02.xfdl");
            this._addPreloadList("fdl","SD::SD10210T03.xfdl");
        };
        
        // User Script
        this.registerScript("SD10210.xfdl", function() {
        ...
        this.loadIncludeScript("SD10210.xfdl");
