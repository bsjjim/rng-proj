(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("영역확장/축소 - 그리드(상하)");
            ...
            obj = new Div("divBottom","0",null,null,"319","40","0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div01");
            ...
            obj = new Static("Static02_00_00",null,"20","69","24","89",null,null,null,null,null,this.divBottom.form);
            obj.set_taborder("3");
            obj.set_text("0");
            obj.set_cssclass("sta_WF_gridCountNum");
            this.divBottom.addChild(obj.name, obj);

            obj = new Static("Static02_01",null,"20","15","24","73",null,null,null,null,null,this.divBottom.form);
            obj.set_taborder("4");
            obj.set_text("건");
            obj.set_cssclass("sta_WF_gridCount");
            this.divBottom.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_00",null,"-2","15","60","60",null,null,null,null,null,this.divBottom.form);
            obj.set_taborder("5");
            obj.set_text("15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_01_01_00_00",null,"3","5","42","84",null,null,null,null,null,this.divBottom.form);
            obj.set_taborder("6");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static02_00_00",null,"20","15","24","449",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("5");
            obj.set_text("건");
            obj.set_cssclass("sta_WF_gridCount");
            this.divTop.addChild(obj.name, obj);

            obj = new Static("Static02_02",null,"20","50","24","394",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("6");
            obj.set_text("[단위:원]");
            obj.set_cssclass("sta_WF_gridCount");
            this.divTop.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_01_00",null,"6","5","47","460",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("7");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_01_01",null,"1","10","47","441",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("8");
            obj.set_text("w10");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_01",null,"-4","15","60","380",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("9");
            obj.set_text("w15");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("Button00_00_01_00_03_00",null,"20","76","24","304",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("10");
            obj.set_text("행추가");
            obj.set_cssclass("btn_Block_addRow");
            this.divTop.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02",null,"20","76","24","224",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("11");
            obj.set_text("행복사");
            obj.set_cssclass("btn_Block_copyRow");
            this.divTop.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_02_00_00",null,"20","76","24","144",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("12");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_Block_delRow");
            this.divTop.addChild(obj.name, obj);

            obj = new Button("Button00_00_01_00_03_00_00_00",null,"20","76","24","64",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("13");
            obj.set_text("행취소");
        ...
        // User Script
        this.registerScript("P-11_show_hide_03.xfdl", function() {
        ...
        this.loadIncludeScript("P-11_show_hide_03.xfdl");
