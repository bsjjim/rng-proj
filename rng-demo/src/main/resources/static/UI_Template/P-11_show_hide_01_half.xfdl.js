(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("영역확장/축소 - 조회영역(하프)");
            ...
            obj = new Div("divSearch","0","0","734","199",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("Static00_00_00_00_00","20","154","60","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("26");
            obj.set_text("매각기간");
            obj.set_cssclass("sta_SA_label_req");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01_02_00_00_00","337","154","63","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("27");
            obj.set_text("차량번호");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("Edit00_00_00_00_00","403","154","80","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("28");
            obj.set_text("10허4048");
            this.divSearch.addChild(obj.name, obj);

            obj = new Button("Button00_00_00_00_00","485","154","24","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("29");
            obj.set_cssclass("btn_Comp_src");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new CalPeriod("CalPeriod00_00_00_00_00","86","154","210","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("30");
            obj.set_cssclass("input_req");
            this.divSearch.addChild(obj.name, obj);

            obj = new Div("divGridWapper","0","divSearch:0","734",null,null,"0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            ...
            obj = new Static("Static01_00_00","155","0","100","50",null,null,null,null,null,null,this.divGridWapper.form);
            obj.set_taborder("1");
            obj.set_text("h50");
            obj.set_cssclass("sta_Guide");
            obj.set_visible("false");
            ...
            obj = new Button("btnSearchExpand","22.71%","divSearch:0","40","20",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("-");
        ...
        // User Script
        this.registerScript("P-11_show_hide_01_half.xfdl", function() {
        ...
        this.loadIncludeScript("P-11_show_hide_01_half.xfdl");
