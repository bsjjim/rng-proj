(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"328\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"계약상태\"/><Cell col=\"2\" text=\"계약번호\"/><Cell col=\"3\" text=\"예약일\"/><Cell col=\"4\" text=\"고객번호\"/><Cell col=\"5\" text=\"고객명\"/><Cell col=\"6\" text=\"예약모델명\"/></Band><Band id=\"body\"><Cell text=\"bind:No\"/><Cell col=\"1\" text=\"bind:계약상태\"/><Cell col=\"2\" text=\"bind:계약번호\"/><Cell col=\"3\" text=\"bind:예약일\"/><Cell col=\"4\" text=\"bind:고객번호\"/><Cell col=\"5\" text=\"bind:고객명\"/><Cell col=\"6\" text=\"bind:예약모델명\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static01","226","13","68","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("계약번호");
            obj.set_cssclass("sta_SA_label_req");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00","20","47","68","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("운전자명");
            ...
            obj = new Static("Static00_00_00","226","47","63","24",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("생년월일");
            obj.set_cssclass("sta_SA_label");
            this.divSearch.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("P-10_popup.xfdl");
